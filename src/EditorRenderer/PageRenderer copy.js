...
class EditingPageRenderer extends Component {
  ...
  onDragOver2=(event,component)=>{
    ...
    if(component.id===this.draggingComponent.parent)
    {
      return;
    }
    if(component.type==='container')
    {
      this.draggingComponent.parent=component;
      //search every other if has the dragging component and remove it
    }
...
export default EditingPageRenderer;
